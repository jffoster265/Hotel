...
namespace XEx10Reservation
{
    public partial class Request : System.Web.UI.Page
    {
        ...
        protected void btnFillForm_Click(object sender, EventArgs e)
        {
            double days = 7;
            txtArrivalDate.Text = currentDate;
            txtDepartureDate.Text = DateTime.Today.AddDays(days).ToShortDateString();
            txtFirstName.Text = "Joe";
            txtLastName.Text = "Foster";
            txtPhone.Text = "715-222-1234";
            txtEmail.Text = "test@test.com";
            txtSpecialRequests.Text = "Free Mini Bar!!!";
            ddlPreferredMethod.SelectedIndex = 1;
            ddlNoOfPeople.SelectedIndex = 2;
            rdoKing.Checked = true;
